...
HD_PWD='C:/Karatsuba/Karatsuba_Multiplication/Karatsuba_kria/Karatsuba_kria.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log karatsuba_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source karatsuba_1_wrapper.tcl -notrace
