...
HD_PWD='C:/Karatsuba/Karatsuba_Multiplication/Karatsuba_kria/Karatsuba_kria.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log karatsuba_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source karatsuba_1_wrapper.tcl
