...
--               c:/Karatsuba/Karatsuba_Multiplication/Karatsuba_kria/Karatsuba_kria.gen/sources_1/bd/karatsuba_1/ip/karatsuba_1_karatsuba_pipeline_ip_0_0/karatsuba_1_karatsuba_pipeline_ip_0_0_sim_netlist.vhdl
...
entity karatsuba_1_karatsuba_pipeline_ip_0_0_karatsuba_pipeline is
  port (
  ...
  attribute ORIG_REF_NAME of karatsuba_1_karatsuba_pipeline_ip_0_0_karatsuba_pipeline : entity is "karatsuba_pipeline";
end karatsuba_1_karatsuba_pipeline_ip_0_0_karatsuba_pipeline;

architecture STRUCTURE of karatsuba_1_karatsuba_pipeline_ip_0_0_karatsuba_pipeline is
  ...
  signal \NLW_result_reg[31]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \NLW_result_reg[31]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 1 );
...
\result[31]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\result_reg[31]_i_2\: unisim.vcomponents.CARRY8
     port map (
      ...
      CI_TOP => '0',
      CO(7 downto 0) => \NLW_result_reg[31]_i_2_CO_UNCONNECTED\(7 downto 0),
      DI(7 downto 0) => B"00000000",
      O(7 downto 1) => \NLW_result_reg[31]_i_2_O_UNCONNECTED\(7 downto 1),
      O(0) => p_0_in(31),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity karatsuba_1_karatsuba_pipeline_ip_0_0_karatsuba_pipeline_ip is
  port (
    m00_axis_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    s00_axis_tdata : in STD_LOGIC_VECTOR ( 31 downto 0 );
    s00_axis_aclk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of karatsuba_1_karatsuba_pipeline_ip_0_0_karatsuba_pipeline_ip : entity is "karatsuba_pipeline_ip";
end karatsuba_1_karatsuba_pipeline_ip_0_0_karatsuba_pipeline_ip;

architecture STRUCTURE of karatsuba_1_karatsuba_pipeline_ip_0_0_karatsuba_pipeline_ip is
begin
karatsuba_pipeline_inst: entity work.karatsuba_1_karatsuba_pipeline_ip_0_0_karatsuba_pipeline
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity karatsuba_1_karatsuba_pipeline_ip_0_0 is
  port (
    s00_axis_aclk : in STD_LOGIC;
    s00_axis_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of karatsuba_1_karatsuba_pipeline_ip_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of karatsuba_1_karatsuba_pipeline_ip_0_0 : entity is "karatsuba_1_karatsuba_pipeline_ip_0_0,karatsuba_pipeline_ip,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of karatsuba_1_karatsuba_pipeline_ip_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of karatsuba_1_karatsuba_pipeline_ip_0_0 : entity is "karatsuba_pipeline_ip,Vivado 2024.1";
end karatsuba_1_karatsuba_pipeline_ip_0_0;

architecture STRUCTURE of karatsuba_1_karatsuba_pipeline_ip_0_0 is
...
inst: entity work.karatsuba_1_karatsuba_pipeline_ip_0_0_karatsuba_pipeline_ip
     port map (
      m00_axis_tdata(31 downto 0) => m00_axis_tdata(31 downto 0),
      m00_axis_tready => \^m00_axis_tready\,
      s00_axis_aclk => s00_axis_aclk,
