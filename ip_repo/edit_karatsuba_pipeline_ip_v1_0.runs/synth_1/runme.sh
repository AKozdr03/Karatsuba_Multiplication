...
HD_PWD='c:/karatsuba/karatsuba_multiplication/ip_repo/edit_karatsuba_pipeline_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log karatsuba_pipeline_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source karatsuba_pipeline_ip.tcl
